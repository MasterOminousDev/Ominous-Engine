...
## Requirements
1. The ability to compile Ominous Engine from the source code. All information related to building Ominous Engine is listed [here.](https://masterominousdev.github.io/Ominous-Engine/building)
2. A text editor. Some form of IDE that can support Haxe is recommended, such as Visual Studio Code.

---
### Step 1. Navigation
Navigate to your Ominous Engine source code. In the `source` folder, look for `StoryMenuState.hx`. Open it in your text editor.
