...
4. (optional) If you want to build a specific version of Kade Engine, you can use `git checkout` to switch to it (i.e. `git checkout 1.4-OE`) (remember that versions 1.4 and older cannot build to Linux or HTML5)
